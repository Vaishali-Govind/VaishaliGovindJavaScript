class Authentication {
    ...
    init() {
      this.user.set("vaishali.govind99@gmail.com", "Epam123");
      this.user.set("vish@gmail.com", "123Epam");
      this.user.set("jyot@gmail.com", "Password1");
    }
  ...
  const showRules = () => {
    swal({
      text: "Password should be 4-10 characters long  \ncontain at least one numeric digit \none uppercase and one lowercase letter",
    });
  };